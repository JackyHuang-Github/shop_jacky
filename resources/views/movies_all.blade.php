...
@section('content')
  ...
  <body>
    ...
    <a href="http://localhost:6080/shop_jacky/public/">首頁<span class="paging">>>即將上映</span></a>
      ...
      <div class="title"></div>
        <div class="movie-list">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/1" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/2" class="movie-item">
          ...
          {{-- <a target="_blank" href="https://www.youtube.com/watch?v=IJDVxBJsbcg" class="movie-item"> --}}
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/3" class="movie-item">
          ...
          {{-- <a target="_blank" href="https://www.youtube.com/watch?v=IJDVxBJsbcg" class="movie-item"> --}}
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/4" class="movie-item">
          ...
          {{-- <a target="_blank" href="https://www.youtube.com/watch?v=IJDVxBJsbcg" class="movie-item"> --}}
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/5" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/6" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/7" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/8" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/9" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/10" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/11" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/12" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/13" class="movie-item">
          ...
          <a target="_blank" href="http://localhost:6080/shop_jacky/public/movie/14" class="movie-item">
